...
const CUSTOM_MODEL_PROVIDER_CHOICES: &[EnumChoice] = &[
    ...
    EnumChoice {
        canonical: "runinfra",
        display: "RunInfra",
        description: "api.runinfra.ai Chat Completions (RUNINFRA_GATEWAY_KEY).",
    },
    EnumChoice {
        canonical: "gemini",
        display: "Google Gemini",
        description: "Google AI Studio Chat Completions (GEMINI_API_KEY).",
    },
    EnumChoice {
        canonical: "wafer",
        display: "Wafer AI",
    ...
    EnumChoice {
        ...
        display: "OpenRouter",
        description: "OpenRouter catalog.",
    },
];
...
pub fn default_settings() -> Vec<SettingMeta> {
    ...
    vec![
        ...
        SettingMeta {
            ...
            kind: SettingKind::DynamicMultiSelect {
                source: crate::settings::DynamicMultiSelectSource::OpenRouterModels,
            },
            restart_required: false,
            hidden_in_minimal: false,
        },
        ...
        SettingMeta {
            ...
            keywords: &[
                "custom", "model", "provider", "zai", "runinfra", "gemini", "wafer", "kimi", "xai",
            ],
            kind: SettingKind::Enum {
                default: "",
        ...
        SettingMeta {
            ...
            description: "Search backend for OpenRouter sessions. Falls back to none when neither xAI nor Perplexity is signed in. Applies to new sessions.",
            keywords: &[
                "web",
                "search",
                "source",
