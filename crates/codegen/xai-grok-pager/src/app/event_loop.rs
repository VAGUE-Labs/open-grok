...
fn startup_codex_freshness_required(
    ...
    match required_provider {
        ...
        None => match selected_provider {
            ...
            | PrimaryProvider::OpenRouter => false,
        },
    }
}
...
fn plan_startup_auth(
    ...
    if let Some(required_provider) = required_provider {
        return match required_provider {
            ...
            | PrimaryProvider::Runinfra
            | PrimaryProvider::Gemini
            | PrimaryProvider::OpenRouter => StartupAuthPlan::Ready,
        };
    }
...
pub(crate) async fn run(
    ...
    {
        let stamp = crate::app::session_startup::active_local_workspace().unwrap_or(None);
