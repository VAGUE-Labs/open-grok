...
use super::setters::{
    ...
    set_display_refresh_auto_cadence_inner, set_enter_steers_inner, set_follow_up_behavior_inner,
    set_fork_secondary_model_inner, set_group_tool_verbs_inner, set_hunk_tracker_mode_inner,
    set_image_generation_provider_inner, set_invert_scroll_inner, set_keep_text_selection_inner,
    ...
    set_stream_tool_calls_inner, set_theme_inner, set_timeline_inner, set_timestamps,
...
pub(in crate::app::dispatch) fn wafer_api_key_status() -> crate::settings::SecretStatus {
    if xai_grok_shell::wafer_models::environment_api_key_is_configured() {
        crate::settings::SecretStatus::EnvironmentOverride
    } else if xai_grok_shell::auth::provider_api_key_is_configured(
        &xai_grok_tools::util::grok_home::grok_home(),
...
pub(in crate::app::dispatch) fn dispatch_open_wafer_api_key_editor(
    app: &mut AppView,
) -> Vec<Effect> {
    use crate::views::modal::ActiveModal;
    use crate::views::settings_modal::SettingsModalState;
