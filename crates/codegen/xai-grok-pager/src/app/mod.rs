...
pub async fn run(
    ...
    let screen_mode = init.screen_mode;
    let startup_typeahead = init.startup_typeahead;
...
mod tests {
    ...
    #[cfg(feature = "local-workspace")]
    #[test]
    fn cli_chat_flag_accepted_with_local_workspace_feature() {
        let args = try_parse_pager(&["grok-pager", "--chat"]).unwrap();
        assert!(args.chat());
    }
    #[cfg(feature = "local-workspace")]
    #[test]
